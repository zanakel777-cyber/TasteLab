...
export function VeiklosKortele({ veikla, children }: { veikla: KortelesVeikla; children: ReactNode }) {
  ...
  return (
    <article className="tl-card flex flex-col">
      {veikla.image_url?.trim() ? (
        ...
        <img src={veikla.image_url} alt={veikla.title} loading="lazy" className="h-44 w-full object-cover" />
      ) : (
